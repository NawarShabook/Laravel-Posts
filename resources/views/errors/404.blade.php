...
<div class="not-found parallax">
            ...
            <a class="wave-island" href="{{url()->previous()}}">
...
<!-- partial -->
  <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js'></script><script  src="/404/script.js"></script>
